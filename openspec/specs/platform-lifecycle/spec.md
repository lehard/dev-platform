...
For non-trivial OpenSpec work, agents SHALL update planning artifacts before knowingly implementing a changed intent, observable behavior, technical design, or execution plan. Project-specific verification and semantic `/opsx:verify` SHALL be completed before archive.
