# CI Safety Specification

## Purpose

Dev Platform CI and publication safety SHALL ensure that reduced-cost validation remains fail-closed, protected-main delivery is authoritative and worktree-safe, and managed rollout stays reproducible without bypassing project-owned QA or GitHub protection.
## Requirements
