...
## Purpose
Define how Dev Platform offers frontend design guidance as opt-in optional engineering capabilities — a general profile plus explicitly-selected specialized visual profiles — that stay subordinate to project product and design requirements, load only for real UI create/redesign/quality work, and use pinned, reviewable external provenance.
## Requirements
