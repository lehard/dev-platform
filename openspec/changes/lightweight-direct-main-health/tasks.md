...
- [ ] 2.1 Run selected platform-managed checks only on pull requests.
- [ ] 2.2 Run full platform-managed checks only on manual dispatch.
- [ ] 2.3 Keep direct main push to common platform/OpenSpec health only.
- [ ] 2.4 Update generated guidance.

## 3. Tests and verification

- [ ] 3.1 Update template contract assertions for event-specific selected/full execution.
