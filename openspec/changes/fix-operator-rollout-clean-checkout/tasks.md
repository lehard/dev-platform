...
## 1. Correct rollout invocation

- [x] Supply selected operator integration through Copier render data for normal update and guarded recopy.
- [x] Remove the pre-update answer-file mutation while retaining post-update contract checks.
...
reviewable downstream rollout PRs are mandatory delivery steps, but cannot be
checked off before archive because release references are derived from merged
archived source.
