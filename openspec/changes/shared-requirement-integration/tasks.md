...
- [x] Add exact ordered multi-child candidate assembly in an isolated worktree with overlap, freshness and ownership checks.
- [x] Reuse protected full checks and exact-head PR publication once for the combined candidate.
- [x] Reconcile terminal merge to each contributing child without inventing an independent completion ledger.
