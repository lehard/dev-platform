...
class DirectMainHealthTests(unittest.TestCase):
    def test_generated_platform_ci_runs_protected_full_checks_on_pr_and_manual_dispatch(self) -> None:
        ...
        self.assertEqual(workflow.count("--mode protected-full --execute"), 2)
        self.assertNotIn('github.base_ref }}{% endraw %}" --execute', workflow)
