...
class TemplateContractTests(unittest.TestCase):
    def test_required_template_files_exist(self) -> None:
        required = ["copier.yml", "template/AGENTS.md.jinja", "template/CLAUDE.md.jinja", "template/.dev-platform.toml.jinja", "template/dev-platform/checks.toml", "template/dev-platform/deepseek-harness-observation.cordis.yml", "template/requirements/deepseek-harness.txt", "template/.github/workflows/dev-platform.yml.jinja", "template/scripts/shared_workspace.py", "template/scripts/agent_board.py", "template/scripts/start_worktree.py", "template/scripts/worktree_cleanup.py", "template/scripts/start_task.py", "template/scripts/managed_task.py", "template/scripts/managed_project_status.py", "template/scripts/start_managed_task.py", "template/scripts/execute_managed_task.py", "template/scripts/deepseek_harness_runtime.py", "template/scripts/select_checks.py", "template/scripts/project_sync.py", "template/scripts/project_publish.py", "template/scripts/finish_task.py", "template/scripts/reconcile_task.py", "template/scripts/task_reconciliation.py", "template/scripts/openspec_lifecycle.py", "template/scripts/merge_to_main.py", "template/scripts/agent_friction.py", "template/scripts/agent_doctor.py", "template/scripts/model_routing.py", "template/scripts/platform_bootstrap.py", "template/scripts/platform_doctor.py", "template/scripts/git_hooks/pre-commit", "template/scripts/git_hooks/pre-merge-commit"]
