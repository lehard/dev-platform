...
class CapabilityManagerTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        for name in ("repository-hygiene.toml", "repository-hygiene.md", "capability-catalog.toml", "capability-catalog.md", "systematic-bug-diagnosis.toml", "systematic-bug-diagnosis.md"):
